...
function AddListingContent() {
  ...
  const handleFeaturesChange = (featureName, isChecked) => {
    ...
    setSelectedFeatures((prevFeature) => [
      ...prevFeature,
      features.CarFeatures.filter((feature) => feature.name === featureName)[0].name,
    ]);
  };
  ...
  const handleCarNotAllowed = (notAllowed) => {
      ...
      <div className='px-10 md:px-20 my-10'>
        ...
        <form className='p-10 border rounded-xl' method='POST'>
          ...
          <UploadImage
            ...
            NotAllowedTriggered={handleCarNotAllowed}
          />
          {carAllowed ? (
            <div className='mt-10 flex justify-center'>
              {!uploadDone ? (
                <>
                  {!loader ? (
                    <Button onClick={handleSubmitForm} disabled={loader}>
                      Save
                    </Button>
                  ) : (
                    <Loader />
            ...
            <div className='mt-10 flex justify-center text-red-600 bg-red-300 rounded-lg p-5'>
