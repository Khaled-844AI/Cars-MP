...
const ProfilePage = () => {
  ...
  <div className="ml-20">
    ...
    <div className="flex items-center justify-between">
      ...
      <Button className="ml-auto" onClick={HandleStartConversation}>Start Conversation</Button>
    </div>
  </div>

        {/* Introduction Section */}
        <div className="mt-8 max-w-7xl mx-auto p-6">
          {fetchedUser?.publicMetadata?.isDealer && <h2 className="max-w-[50rem] sm:max-w-[49rem] mb-10 px-3 md:px-0 sm:text-5xl md:text-7xl text-4xl font-bold font-display md:leading-[1.1em] bg-gradient-to-b from-gray-800 to-gray-300 text-transparent bg-clip-text text-start">Available Cars</h2>}
